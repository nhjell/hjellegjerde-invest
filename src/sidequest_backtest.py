"""SIDE QUEST - quick and dirty backtest, NOT the rigorous Stage 4 backtest.
...
treat this as directional, not conclusive. Run with: python sidequest_backtest.py
"""
...
def main():
    ...
    out_path = ROOT / "data" / "processed" / "sidequest_backtest_observations.csv"
